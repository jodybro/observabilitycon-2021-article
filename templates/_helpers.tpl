...
*/}}
{{- define "observabilitycon2021.chart" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/* Common labels */}}
{{- define "observabilitycon2021.labels" -}}
helm.sh/chart: {{ include "observabilitycon2021.chart" . | quote }}
...
*/}}
{{- define "observabilitycon2021.appVersion" -}}
